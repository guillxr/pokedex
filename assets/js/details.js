...
function loadPokemonCard() {
  pokeApi.getPokemonByIdPokeapi(pokemonId).then((pokemon) => {
    pokeApi.getPokemonByIdSpecies(pokemonId).then((species) => {
      const stats = {};
          ...
          <div class="header loading">
            ...
            <div class="information">
              ...
              <div class="id-and-genus">
                ...
                <span class="genus">${species.genus}</span>
              </div>
            </div>
            <div class="image">
                ...
                <div class="about" id="about-content">
                  <div>
                    <div class="description">
                      ${capitalizeFirst(species.description.replace("\f", " "))}
                    </div>
                  ...
                  <div class="breending">
                    ...
                    <div class="eggGroups">
                      ...
                      <div class="groups">
                        ${species.eggGroups.map((group) => `<span>${group}</span>`).join(', ')}
                      </div>
                    </div>
                  </div>
                </div>
                  ...
                  <div class="stats-box">
                    <div class="stats-name">
                      ${pokemon.stats.map((stats) => `
                        ...
                        <div class="stat-name total">total</div>
                    </div>
                    <div class="stats-value">
                      ...
                      <div class="stat-box-value speed">
                        ...
                        <div class="stat-indicator">
                          <div class="bar ${colorProgressBar((total / 1125) * 100)}" style="width: ${((total / 1125) * 100).toFixed(0)}%"></div>
                        </div>
                      </div>
                    </div>
                  </div>
